...
object_mobile_vehicle_shared_tiebomber = SharedCreatureObjectTemplate:new {
	clientTemplateFileName = "object/mobile/vehicle/shared_tiebomber.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	acceleration = {10,3},
	animationMapFilename = "",
...
ObjectTemplates:addClientTemplate(object_mobile_vehicle_shared_tiebomber, "object/mobile/vehicle/shared_tiebomber.iff")
