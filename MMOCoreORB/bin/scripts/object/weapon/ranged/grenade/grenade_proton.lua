...
object_weapon_ranged_grenade_grenade_proton = object_weapon_ranged_grenade_shared_grenade_proton:new {
	...
	healthAttackCost = 3130,
	actionAttackCost = 2175,
	mindAttackCost = 865,
	...
	experimentalMin = {0, 0, 1923, 3300, 9, 100, 1000, 16, 45, 18, 10, 64, 839, 878, 825},
	experimentalMax = {0, 0, 2534, 4900, 4.5, 100, 1000, 22, 65, 19, 25, 64, 785, 773, 786},
