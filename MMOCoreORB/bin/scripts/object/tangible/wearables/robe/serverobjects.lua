...
--Custom Robe
includeFile("tangible/wearables/robe/robe_madness.lua")
includeFile("tangible/wearables/robe/itho_madness.lua")
includeFile("tangible/wearables/robe/wke_madness.lua")
