...
object_tangible_deed_vehicle_deed_shared_tieoppressor_deed = SharedTangibleObjectTemplate:new {
 clientTemplateFileName = "object/tangible/deed/vehicle_deed/shared_tieoppressor_deed.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/eqp_tool_datapad.apt",
	arrangementDescriptorFilename = "",
...
ObjectTemplates:addClientTemplate(object_tangible_deed_vehicle_deed_shared_tieoppressor_deed, "object/tangible/deed/vehicle_deed/shared_tieoppressor_deed.iff")
