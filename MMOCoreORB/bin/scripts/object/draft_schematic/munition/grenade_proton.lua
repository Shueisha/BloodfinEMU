...
object_draft_schematic_munition_grenade_proton = object_draft_schematic_munition_shared_grenade_proton:new {
   ...
   ingredientTitleNames = {"shell", "thumb_trigger", "activation_indicator", "warhead_insulator", "igniter_charge", "warhead_assembly", "null_field_generator", "warhead_fusing", "alum_minerals"},
   ingredientSlotType = {0, 0, 0, 0, 1, 1, 1, 1, 1},
   resourceTypes = {"metal", "steel", "petrochem_inert_polymer", "ore_siliclastic_crism", "object/tangible/component/munition/shared_warhead_light.iff", "object/tangible/component/munition/shared_warhead_medium.iff", "object/tangible/component/munition/shared_warhead_stabilizer.iff", "object/tangible/component/munition/shared_warhead_fusing_mechanism.iff", "object/tangible/loot/dungeon/death_watch_bunker/shared_binary_liquid.iff"},
