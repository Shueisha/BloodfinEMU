...
object_building_player_city_cloning_naboo = object_building_player_city_shared_cloning_naboo:new {
	...
	allowedZones = {"dantooine", "naboo", "rori", "yavin4" },
	length = 1,
	width = 1,
	cityRankRequired = 1,
	...
	childObjects = {
			{templateFile = "object/tangible/sign/player/house_address_naboo.iff", x = 9.75, z = 2, y = -3, ox = 0, oy = 0.707107, oz = 0, ow = -0.707107, cellid = -1, containmentType = -1},
