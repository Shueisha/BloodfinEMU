...
object_intangible_vehicle_shared_tiebomber_pcd = SharedIntangibleObjectTemplate:new {
	clientTemplateFileName = "object/intangible/vehicle/shared_tiebomber_pcd.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/clone_barc_speeder.apt",
	arrangementDescriptorFilename = "",
...
ObjectTemplates:addClientTemplate(object_intangible_vehicle_shared_tiebomber_pcd, "object/intangible/vehicle/shared_tiebomber_pcd.iff")
