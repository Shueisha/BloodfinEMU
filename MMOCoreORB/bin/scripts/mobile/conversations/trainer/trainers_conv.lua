...
createTrainerConversationTemplate("trainer_fsenses", "force_sensitive_heightened_senses_master", "trainer_fsenses_convotemplate")
createTrainerConversationTemplate("trainer_fmastery", "force_sensitive_crafting_mastery_master", "trainer_fmastery_convotemplate")
createTrainerConversationTemplate("trainer_freflexes", "force_sensitive_enhanced_reflexes_master", "trainer_freflexes_convotemplate")
createTrainerConversationTemplate("trainer_fprowess", "force_sensitive_combat_prowess_master", "trainer_fprowess_convotemplate")
