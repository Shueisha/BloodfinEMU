...
--custom group
includeFile("groups/halloween_loot.lua")
includeFile("groups/youngling_loot.lua")
includeFile("groups/dark_jedi_loot.lua")
includeFile("groups/emp_hand.lua")
includeFile("groups/chasmal_spider.lua")
includeFile("groups/thanksgiving.lua")
includeFile("groups/goggles.lua")
includeFile("groups/dev.lua")
includeFile("groups/fifth_gen.lua")
includeFile("groups/easter_common.lua")
includeFile("groups/party_crate.lua")
includeFile("groups/mando_loot.lua")
includeFile("groups/world_boss_loot.lua")
includeFile("groups/dws_house_loot.lua")
includeFile("groups/gen_grv.lua")
includeFile("groups/cor_crew.lua")
includeFile("groups/madness_robes.lua")
...
includeFile("groups/geonosian_lab/boogles_geo_group/geo_jawa_cache.lua")
--Geo--

--Armor--
includeFile("groups/armor/boogles_armors/enhanced_geo_armor.lua")
--Armor--

--Weapons--
includeFile("groups/weapon/boogles_weapon_group/enhanced_melee_geo_weapons.lua")
includeFile("groups/weapon/boogles_weapon_group/enhanced_ranged_geo_weapons.lua")
--Weapons--

--Wearables--
includeFile("groups/wearables/boogles_wearables/mastery_geocave_jewelry.lua")
includeFile("groups/wearables/boogles_wearables/jedi_geocave_jewelry.lua")
includeFile("groups/wearables/boogles_wearables/geo_crafting_jewelry_modified.lua")
--Wearables--
------------------------------Boogles Custom------------------------------
