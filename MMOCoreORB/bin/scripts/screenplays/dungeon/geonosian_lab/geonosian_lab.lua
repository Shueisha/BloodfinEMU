...
--poison area before new bosses
	...
	if (pPoisonCloudCC ~= nil) then
		local activeArea = LuaActiveArea(pPoisonCloudCC)
...
--Secondary electric shock area
	...
	if (pElectroShock2 ~= nil) then
		local activeArea = LuaActiveArea(pElectroShock2)
...
--Tertiary electric shock area
	...
	if (pElectroShock3 ~= nil) then
		local activeArea = LuaActiveArea(pElectroShock3)
...
function geonosian_labscreenplay:spawnMobiles()
	...
	spawnMobileRandom("yavin4", "acklay",900,101.1,-34.3,-321.6,-136,1627823)
        spawnMobileRandom("yavin4", "enhanced_gaping_spider",900,-130,-22.1,-85,-180,1627794)
	...
	spawnMobile("yavin4", "enhanced_cavern_spider",300,-118.9,-34.0,-349.2,-98,1627818)
	...
	-->>Enhanced Rancor??
	spawnMobile("yavin4", "enhanced_rancor",900, -149.346, -34.0142, -369.433, 52, 1627818)
	-->>Enhanced Rancor??

	-->>Dark Jedi Jawa<<--
	spawnMobile("yavin4", "enhanced_force_jawa_lord",1800, 4.0, -34, -347.3, -91, 1627822)
	-->>Dark Jedi Jawa<<--
