...
--includeFile("dungeon/corvette/imperial/travelr.lua")
--includeFile("dungeon/corvette/imperial/traveln.lua")
...
CorvetteScreenPlay = ScreenPlay:new {
	...
	-- Cant have mutable globals in lua here
...
--------------------------------------------------------------
spawnMapImperial =  {
		{"sun_crew", 0, -10, 0, -10.2, -10, 4336209},
		{"sun_crew", 0, 4.9, 0, -30.9, -10, 4336213},
		{"sun_crew", 0, 5, 0, -20.9, 170, 4336213},
		{"sun_crew", 0, 26.2, 0, 0, -100, 4336207},
		{"sun_crew", 0, 20, 0, 16, -10, 4336206},
		{"sun_crew", 0, 4.7, 0, 50, -100, 4336203},
		{"sun_crew", 0, 14.3, 0, 51.6, -100, 4336203},
		{"sun_crew", 0, -2.6, 0, 60.5, 170, 4336203},
		{"sun_crew", 0, 5.3, 0, 18.1, 80, 4336201},
		{"sun_crew", 0, -0.1, 0, 9.4, -10, 4336199},
		{"sun_crew", 0, 0, 0, 23.3, 170, 4336199},

		{"sun_crew", 0, 10, 0, 17.6, 170, 4336208},

		{"sun_crew", 0, -2.9, 12, -16.3, 170, 4336216},
		{"sun_crew", 0, -2.9, 12, 14.9, 170, 4336216},
		{"sun_crew", 0, 1, 12, -8.2, -10, 4336217},
		{"sun_crew", 0, 3, 12, -0.7, 170, 4336217},

		{"sun_crew", 0, 2.8, 12, 4.1, -10, 4336218},
		{"sun_crew", 0, 4.9, 12, 15, 170, 4336218},
	
		{"sun_crew", 0, 6.4, 15, 37, -10, 4336219},
		{"sun_crew", 0, 3.6, 15, 37, -10, 4336219},
		{"sun_crew", 0, 0.9, 15, 33.7, -135, 4336219},

		{"sun_crew", 0, 0, -12, 28.5, -10, 4336227},

		{"sun_crew", 0, 26.2, -12, 27.9, -100, 4336230},

		{"sun_crew", 0, 10.9, -12, 5.4, -10, 4336229},

		{"sun_crew", 0, 2.8, 0, -40.2, -100, 4336220},
		{"sun_crew", 0, -7.2, 0, -37.7, -100, 4336220},
		{"sun_crew", 0, 16.4, -12, -41.7, 80, 4336220},
		{"sun_crew", 0, 27.1, -12, -60.8, -10, 4336220},
		{"sun_crew", 0, 13.4, -12, -58.9, 80, 4336220},
		{"sun_crew", 0, -11.9, -12, -40.1, -100, 4336220},
		{"sun_crew", 0, -21.4, -12, -59.8, -50, 4336220},
		{"sun_crew", 0, -7.6, -14, -45.4, 170, 4336220},

		{"sun_crew", 0, 7.5, -14, -39, 170, 4336224},

		{"sun_crew", 0, -11.2, -12, 5.3, -10, 4336234},
		{"sun_crew", 0, -7.4, -12, 11.2, 170, 4336234},
		{"sun_crew", 0, -4.1, -12, 6.3, -100, 4336234},

		{"sun_crew", 0, -25, -12, 28, 80, 4336235},

		{"sun_crew", 0, -6.4, -6.7, -36, -100, 4336223},
		{"sun_crew", 0, -6, -6.7, -39.9, -10, 4336223},

		{"sun_crew", 0, -7.6, -12, 40.8, -150, 4336238},

		{"sun_crew", 0, 2.6, -12, 55, -150, 4336236},

		{"sun_crew", 0, -2.7, -12, 71, 80, 4336243},
		{"sun_crew", 0, 3.3, -12, 73.6, -10, 4336243},

		{"sun_crew", 0, 24.5, -12, 62.8, -100, 4336241},
		{"sun_crew", 0, 17.6, -12, 69.5, -10, 4336241},

		{"sun_crew", 0, -22.6, -12, 51.8, 80, 4336244},

		{"sun_crew", 0, -21.1, -12, 68.3, 170, 4336242},
		{"sun_crew", 0, -24.6, -12, 64.1, 80, 4336242},
		{"sun_crew", 0, -17.4, -12, 64.1, -100, 4336242},

		{"sun_crew", 0, 0, -12, 100.7, 170, 4336248},

		{"sun_crew", 0, -17, -12, 112.9, 130, 4336249},
		{"sun_crew", 0, 17, -12, 112.9, -150, 4336249},

		{"sun_crew", 0, 0, -12, 117.4, 170, 4336250},
		{"sun_crew", 0, -5.8, -12, 127.5, 170, 4336250},

		{"sun_crew", 0, -5.4, -12, 133.6, 170, 4336251},
		{"sun_crew", 0, 5.6, -12, 132.7, -100, 4336251},

		{"sun_crew", 0, 0, -24, 98.3, -10, 4336254},

		{"sun_crew", 0, 3.3, -27, 75.6, 157, 4336256},
		{"sun_crew", 0, 3.2, -27, 78.6, 45, 4336256},

		{"sun_crew", 0, 0.7, 0, 111.5, -100, 4336257},
		{"sun_crew", 0, -16.3, 0, 112, -50, 4336257},

		{"sun_crew", 0, 0, 0, 127.8, 170, 4336258},

	--"Rebel Commander", 0, -5.8, 0, 133.1, -10, 4336261},	
		{"sun_crew", 0, -3.5, 0, 125.3, -10, 4336261},

		{"sun_crew", 0, 3.8, 0, 124.9, -10, 4336260},
		{"sun_crew", 0, 6.7, 0, 134.4, 170, 4336260},

		{"sun_crew", 0, 0, 0, 150.3, -10, 4336262},
		{"sun_crew", 0, -4.4, 0, 148.3, 130, 4336262},
		{"sun_crew", 0, 4.5, 0, 148.3, -150, 4336262}
	},
...
spawnMapNeutral =  {
		...
		{"sun_crew", 0, 14.3, 0, 51.6, -100, 4336203},
		{"sun_crew", 0, -2.6, 0, 60.5, 170, 4336203},
		{"sun_crew", 0, 5.9, 0, 18.1, 80, 4336201},
		{"sun_crew", 0, -0.1, 0, 9.4, -10, 4336199},
		{"sun_crew", 0, 0, 0, 23.3, 170, 4336199},
...
spawnMapRebel =  {
		...
		{"sun_crew", 0, 14.3, 0, 51.6, -100, 4336203},
		{"sun_crew", 0, -2.6, 0, 60.5, 170, 4336203},
		{"sun_crew", 0, -10.9, 0, 18.1, 80, 4336201},
		{"sun_crew", 0, -0.1, 0, 9.4, -10, 4336199},
		{"sun_crew", 0, 0, 0, 23.3, 170, 4336199},
...
function CorvetteScreenPlay:start()
	...
	if (isZoneEnabled("naboo")) then
		-- Imperial Start 1.
--		spawnMobile("tatooine", "lt_velso", 0, -1431.8,-0.0,-5659.2, 160, 0) -- 2405 -3967

		-- Imperial Travel Point.
--		spawnMobile("tatooine", "cor_imperial_pilot", 0, -1433.8,-0.0,-5659.2, 160, 0)
	end

	if (isZoneEnabled("tatooine")) then
		-- Imperial Start 2.
--		spawnMobile("tatooine", "landau", 0, -1435.8,-0.0,-5659.2, 160, 0) -- -1291 -3539

		-- Imperial Start 3.
--		spawnMobile("tatooine", "chiss_female", 0, -1437.8,-0.0,-5659.2, 160, 0) -- -5313 2662
...
function CorvetteScreenPlay:startInstance(pFaction, pPlayerOwner)
		...
		for i = 0, gSize do
			...
			if (groupMember ~= nil) then
				if (groupMember ~= pPlayerOwner) then
					ownerCreature:sendSystemMessage("You have 5 minutes before you are detected and transported back to Mos Bloodfin.")
	...
	elseif (pFaction == "neutral") then
	self:spawnMobilesNeutral()	
	elseif (pFaction == "rebel") then
	self:spawnMobilesRebel()
	end
...
function CorvetteScreenPlay:ownerDied(pOwner, pKiller)
	...
	elseif (creatureObject:isNeutral()) then
		for i,v in ipairs(self.spawnMapNeutral) do		
			local checkIfKilled = readData(i .. ":neutral:vette:objid")
			if (checkIfKilled == 0) then
				local spawnedSceneObject = LuaSceneObject(nil)
				local spawnedPointer = spawnMobile("dungeon1", v[1], v[2], v[3], v[4], v[5], v[6], v[7])
				if (spawnedPointer ~= nil) then
					spawnedSceneObject:_setObject(spawnedPointer)
					writeData(i .. ":neutral:vette:objid", spawnedSceneObject:getObjectID())
					createObserver(OBJECTDESTRUCTION, "CorvetteScreenPlay", "spawnKilled", spawnedPointer)
				end
			end
		end	
	elseif (creatureObject:isRebel()) then
		for i,v in ipairs(self.spawnMapRebel) do		
			local checkIfKilled = readData(i .. ":rebel:vette:objid")
			if (checkIfKilled == 0) then
				local spawnedSceneObject = LuaSceneObject(nil)
				local spawnedPointer = spawnMobile("dungeon1", v[1], v[2], v[3], v[4], v[5], v[6], v[7])
				if (spawnedPointer ~= nil) then
					spawnedSceneObject:_setObject(spawnedPointer)
					writeData(i .. ":rebel:vette:objid", spawnedSceneObject:getObjectID())
					createObserver(OBJECTDESTRUCTION, "CorvetteScreenPlay", "spawnKilled", spawnedPointer)
				end
			end
		end	
...
function CorvetteScreenPlay:spawnKilled(pSpawn, pKiller)
	...
	elseif (creatureObject:isNeutral()) then
		for i,v in ipairs(self.spawnMapNeutral) do		
			local checkIfKilled = readData(i .. ":neutral:vette:objid")
			if (checkIfKilled == spawnCreature:getObjectID()) then
				deleteData(i .. ":neutral:vette:objid")
			end
		end	
	elseif (creatureObject:isRebel()) then
		for i,v in ipairs(self.spawnMapRebel) do		
			local checkIfKilled = readData(i .. ":rebel:vette:objid")
			if (checkIfKilled == spawnCreature:getObjectID()) then
				deleteData(i .. ":rebel:vette:objid")
			end
		end	
	end
...
function CorvetteScreenPlay:instanceFailed(pPlayer)
	...
	playerCreature:sendSystemMessage("You have been detected! Evac procedure engaged. Transporting you back to your shuttle point...")
	...
	if (sceneObject:getTemplateObjectPath() == "object/building/general/space_dungeon_corellian_corvette_imperial.iff") then
		...
		playerScene:switchZone("tatooine", -1435, 0, -5666, 0)
	...
	if (playerCreature:isNeutral()) then
		for i,v in ipairs(self.spawnMapNeutral) do
			local deletionCheck = readData(i .. ":neutral:vette:objid")
			local creatureToRemove = getCreatureObject(deletionCheck)
	...
	if (playerCreature:isRebel()) then
		for i,v in ipairs(self.spawnMapRebel) do
			local deletionCheck = readData(i .. ":rebel:vette:objid")
			local creatureToRemove = getCreatureObject(deletionCheck)
...
function CorvetteScreenPlay:spawnMobilesRebel()
	local spawnedSceneObject = LuaSceneObject(nil)
...
function CorvetteScreenPlay:spawnMobilesNeutral()
	local spawnedSceneObject = LuaSceneObject(nil)
