...
--Custom
includeFile("dungeon/rebel_corvette.lua")
includeFile("dungeon/imperial_corvette.lua")
includeFile("dungeon/corvette_pve.lua")
includeFile("dungeon/pvp_corvette.lua")
--includeFile("dungeon/corvette/corvette.lua")
includeFile("event/knightTrial.lua")
...
--events
includeFile("event/bloodfin_starport.lua")
--includeFile("event/bloodfin_starport2.lua")
includeFile("event/stresstest_20120128.lua")
--includeFile("event/blue_frog.lua")
includeFile("event/iconic_nge.lua")
includeFile("event/addon_starports.lua")
--includeFile("event/black_sun_event.lua")
--includeFile("event/halloween.lua")
includeFile("event/younglings_bloodfin.lua")
--includeFile("event/tat_tusken.lua")
--includeFile("event/tat_krayt.lua")
includeFile("event/aurilia.lua")
includeFile("event/mosbloodfin.lua")
includeFile("event/tusken_king.lua")
includeFile("event/arcadia.lua")
--includeFile("event/dantooine_mining_outpost_test.lua")
includeFile("event/bloodfin_cantina.lua")
includeFile("event/addon_starports2.lua")
includeFile("event/dws.lua")
--includeFile("event/force_sensitive.lua")
includeFile("event/padawanTrials.lua")
includeFile("event/padawanTrialsTwo.lua")
includeFile("event/padawanTrialsThree.lua")
includeFile("event/padawanTrialsFour.lua")
