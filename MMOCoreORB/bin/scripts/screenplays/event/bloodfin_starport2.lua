...
--	local pCollector = spawnSceneObject("corellia", "object/tangible/furniture/all/frn_all_command_console.iff", 3522.6, 5.0, -4810.6, 85, 95, 0, 0, 0)
--	local collector = LuaSceneObject(pCollector)
--	local col2creo = LuaCreatureObject(pCollector)
--	col2creo:setOptionsBitmask(264)
--	collector:setCustomObjectName("\\#ee3377Travel to Mos Bloodfin Starport")
--	createObserver(OBJECTRADIALUSED, "bloodfin_starport2", "teleportMB", pCollector)
...
function bloodfin_starport2:teleportMB(pCollector, pPlayer)
