...
function bloodfin_starport:spawnSceneObjects()
	local pCollector = spawnSceneObject("corellia", "object/tangible/furniture/all/frn_all_command_console.iff", -148.3, 28, -4721.5, 85, 95, 0, 0, 0)
	local collector = LuaSceneObject(pCollector)
	local col2creo = LuaCreatureObject(pCollector)
	col2creo:setOptionsBitmask(264)
	collector:setCustomObjectName("\\#ee3377Travel to Mos Bloodfin Starport")
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportMB", pCollector)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportMB", pCollector2)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportMB", pCollector3)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportNB", pCollector4)
		--Return to starport
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportCnet", pCollector5)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportTT", pCollector6)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportTS", pCollector7)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportRR", pCollector8)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportLK", pCollector9)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportED", pCollector10)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportDT", pCollector11)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportDR", pCollector12)
	...
	createObserver(OBJECTRADIALUSED, "bloodfin_starport", "teleportYV", pCollector13)]]
...
function bloodfin_starport:teleportNB(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("naboo", -4876, 6.1, 4147, 0)
end

function bloodfin_starport:teleportCnet(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("corellia", -159, 28, -4774, 0)
end

function bloodfin_starport:teleportTT(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("tatooine", -1287, 12, -3595, 85)
end

function bloodfin_starport:teleportRR(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("rori", 5364.9, 80, 5664.1, -178)
end

function bloodfin_starport:teleportTS(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("talus", 4453.6, 2.0, 5272.8, -140)
end

function bloodfin_starport:teleportLK(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("lok", 464.2, 8.8, 5502.6, -140)
end

function bloodfin_starport:teleportED(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("endor", -961.9, 73.0, 1546.8, -16)
end

function bloodfin_starport:teleportDT(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("dantooine", -625, 3.0, 2495.2, -127)
end

function bloodfin_starport:teleportDR(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("dathomir", 607.2, 6.0, 3084.8, -61)
end

--[[function bloodfin_starport:teleportYV(pCollector, pPlayer)
	local player = LuaSceneObject(pPlayer)
	player:switchZone("yavin4", -272.4, 35, 4882.6, -127)
end]]
